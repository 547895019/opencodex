...
export const ko: Record<TKey, string> = {
  ...
  "debug.promptCapture": "전체 프롬프트 캡처",
  "debug.promptCapture.title": "전체 프롬프트 캡처",
  "debug.promptCapture.sub": "디버깅용으로 인바운드 요청의 전체 body(messages, tools, system, metadata)를 캡처합니다. 기본 마스킹, 메모리 링만, 끄면 즉시 삭제.",
  "debug.promptCapture.warning": "프롬프트 원문을 저장합니다(Claude inbound “프롬프트 미저장” 계약 위반). 디버깅 시에만 켜고 사용 후 끄십시오. 기본은 secrets 마스킹.",
  "debug.promptCapture.empty": "아직 캡처 없음. 켠 상태에서 메시지를 보내보세요.",
  "debug.promptCapture.time": "시각",
  "debug.promptCapture.surface": "서피스",
  "debug.promptCapture.model": "모델",
  "debug.promptCapture.bodySize": "body 크기",
  "debug.promptCapture.redaction": "마스킹",
  "debug.promptCapture.redactionNone": "없음(원문)",
  "debug.promptCapture.redactionSecrets": "secrets만",
  "debug.promptCapture.redactionSecretsPii": "secrets + PII",
  "debug.promptCapture.maxEntries": "로테이션 한도",
  "debug.promptCapture.clear": "비우기",
  "debug.promptCapture.viewBody": "body 보기",
  "debug.promptCapture.hideBody": "숨기기",
