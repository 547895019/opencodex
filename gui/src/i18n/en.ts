...
export const en = {
  ...
  "dash.visionModelHint": "Model used to describe images for text-only routed models. OpenAI/Anthropic backends need the matching login; the Routed backend can use any configured vision model.",
  ...
  "dash.visionSidecarHint": "Choose the backend and model used to describe images for text-only routed models. The Routed backend sends the describe request to any configured provider model — no ChatGPT login required.",
  ...
  "debug.promptCapture": "Full prompt capture",
  ...
  "debug.promptCapture.title": "Full prompt capture",
  "debug.promptCapture.sub": "Captures the full inbound request body (messages, tools, system, metadata) for debugging. Redacted by default, in-memory ring only, cleared on toggle off.",
  "debug.promptCapture.warning": "This stores full prompt text (it breaks the Claude inbound \"no prompt text\" contract). Enable only while debugging; turn it off when done. Defaults to secrets redaction.",
  "debug.promptCapture.empty": "No requests captured yet. Send a message while this is on.",
  "debug.promptCapture.time": "Time",
  "debug.promptCapture.surface": "Surface",
  "debug.promptCapture.model": "Model",
  "debug.promptCapture.bodySize": "body size",
  "debug.promptCapture.redaction": "Redaction",
  "debug.promptCapture.redactionNone": "None (verbatim)",
  "debug.promptCapture.redactionSecrets": "Secrets only",
  "debug.promptCapture.redactionSecretsPii": "Secrets + PII",
  "debug.promptCapture.maxEntries": "Rotation limit",
  "debug.promptCapture.clear": "Clear",
  "debug.promptCapture.viewBody": "View body",
  "debug.promptCapture.hideBody": "Hide",
