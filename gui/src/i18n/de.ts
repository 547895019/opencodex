...
export const de = {
  ...
  "debug.promptCapture": "Vollständige Prompt-Erfassung",
  "debug.promptCapture.title": "Vollständige Prompt-Erfassung",
  "debug.promptCapture.sub": "Erfasst den vollständigen Inbound-Body (messages, tools, system, metadata) zum Debuggen. Standardmäßig geschwärzt, nur im RAM, beim Ausschalten gelöscht.",
  "debug.promptCapture.warning": "Speichert vollständige Prompt-Texte (bricht den „kein Prompt-Text“-Vertrag von Claude inbound). Nur zum Debuggen einschalten; danach ausschalten. Standard: Secrets-Schwärzung.",
  "debug.promptCapture.empty": "Noch keine Anfragen erfasst. Senden Sie eine Nachricht, während dies aktiv ist.",
  "debug.promptCapture.time": "Zeit",
  "debug.promptCapture.surface": "Kanal",
  "debug.promptCapture.model": "Modell",
  "debug.promptCapture.bodySize": "Body-Größe",
  "debug.promptCapture.redaction": "Schwärzung",
  "debug.promptCapture.redactionNone": "Keine (wortwörtlich)",
  "debug.promptCapture.redactionSecrets": "Nur Secrets",
  "debug.promptCapture.redactionSecretsPii": "Secrets + PII",
  "debug.promptCapture.maxEntries": "Rotationslimit",
  "debug.promptCapture.clear": "Leeren",
  "debug.promptCapture.viewBody": "Body ansehen",
  "debug.promptCapture.hideBody": "Verbergen",
