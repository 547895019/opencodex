...
export const ru: Record<TKey, string> = {
  ...
  "debug.promptCapture": "Полный захват промптов",
  "debug.promptCapture.title": "Полный захват промптов",
  "debug.promptCapture.sub": "Захватывает полный body входящего запроса (messages, tools, system, metadata) для отладки. По умолчанию маскируется, только в памяти, очищается при выключении.",
  "debug.promptCapture.warning": "Сохраняет полный текст промпта (нарушает договор Claude inbound «без текста промпта»). Включайте только для отладки; после — выключите. По умолчанию маскирование secrets.",
  "debug.promptCapture.empty": "Захвата ещё нет. Отправьте сообщение, пока включено.",
  "debug.promptCapture.time": "Время",
  "debug.promptCapture.surface": "Канал",
  "debug.promptCapture.model": "Модель",
  "debug.promptCapture.bodySize": "размер body",
  "debug.promptCapture.redaction": "Маскирование",
  "debug.promptCapture.redactionNone": "Нет (как есть)",
  "debug.promptCapture.redactionSecrets": "Только secrets",
  "debug.promptCapture.redactionSecretsPii": "Secrets + PII",
  "debug.promptCapture.maxEntries": "Лимит ротации",
  "debug.promptCapture.clear": "Очистить",
  "debug.promptCapture.viewBody": "Показать body",
  "debug.promptCapture.hideBody": "Скрыть",
