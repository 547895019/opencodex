...
export const zh: Record<TKey, string> = {
  ...
  "dash.visionModelHint": "为纯文本路由模型描述图像的模型。OpenAI/Anthropic 后端需要对应登录；路由后端可用任意已配置的视觉模型。",
  "dash.webSearchSidecar": "网页搜索附属服务",
  "dash.webSearchSidecarHint": "选择路由模型进行网页搜索时使用的后端和模型。",
  "dash.visionSidecar": "视觉附属服务",
  "dash.visionSidecarHint": "选择纯文本路由模型描述图像时使用的后端和模型。路由后端把描述请求发给任意已配置的路由模型，无需 ChatGPT 登录。",
  ...
  "debug.promptCapture.title": "全量提示词采集",
  "debug.promptCapture.sub": "捕获入站请求的完整 body（messages、tools、system、metadata），用于排查。默认脱敏，仅内存环形缓冲，关闭即清空。",
  "debug.promptCapture.warning": "此功能保存完整提示词原文（突破 Claude 入站“不存提示词”的契约）。仅在排查需要时开启，用完务必关闭；默认脱敏 secrets。",
  "debug.promptCapture.empty": "尚未捕获任何请求。开启后发送一条消息试试。",
  "debug.promptCapture.time": "时间",
  "debug.promptCapture.surface": "通道",
  "debug.promptCapture.model": "模型",
  "debug.promptCapture.bodySize": "body 大小",
  "debug.promptCapture.redaction": "脱敏",
  "debug.promptCapture.redactionNone": "不脱敏（原文）",
  "debug.promptCapture.redactionSecrets": "仅 secrets",
  "debug.promptCapture.redactionSecretsPii": "secrets + PII",
  "debug.promptCapture.maxEntries": "轮转上限",
  "debug.promptCapture.clear": "清空",
  "debug.promptCapture.viewBody": "查看 body",
  "debug.promptCapture.hideBody": "收起",
  "debug.reset": "清除运行时覆盖",
  "debug.refresh": "刷新",
  "debug.follow": "跟随滚动",
