...
export const ja: Record<TKey, string> = {
  ...
  "debug.promptCapture": "フルプロンプト取得",
  "debug.promptCapture.title": "フルプロンプト取得",
  "debug.promptCapture.sub": "デバッグ用に入站リクエストの完全な body（messages、tools、system、metadata）を取得します。デフォルトでマスク、メモリ内のみ、オフで即クリア。",
  "debug.promptCapture.warning": "プロンプト原文を保存します（Claude inbound の「プロンプト本文を保存しない」契約を破ります）。デバッグ時のみ有効化し、使い終わったら必ずオフに。デフォルトは secrets マスク。",
  "debug.promptCapture.empty": "まだ取得なし。オン中にメッセージを送信してみてください。",
  "debug.promptCapture.time": "時刻",
  "debug.promptCapture.surface": "サーフェス",
  "debug.promptCapture.model": "モデル",
  "debug.promptCapture.bodySize": "body サイズ",
  "debug.promptCapture.redaction": "マスク",
  "debug.promptCapture.redactionNone": "なし（原文）",
  "debug.promptCapture.redactionSecrets": "secrets のみ",
  "debug.promptCapture.redactionSecretsPii": "secrets + PII",
  "debug.promptCapture.maxEntries": "ローテーション上限",
  "debug.promptCapture.clear": "クリア",
  "debug.promptCapture.viewBody": "body 表示",
  "debug.promptCapture.hideBody": "隠す",
